...
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM data_siswa WHERE id_siswa=$id_siswa"));
?>
...
<body>
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE data_siswa SET nama='$nama', kelas='$kelas', jurusan='$jurusan', email='$email', no_hp='$no_hp', foto='$foto' WHERE id_siswa
    =$id_siswa
    ";
